...
# python figaro/figaro.py --ampliconLength 470 --forwardPrimerLength 16 --reversePrimerLength 24
...
colnames(track) <- c("inputt", "filtered", "denoisedF", "denoisedR", "merged", "nonchim")
